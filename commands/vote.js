    ...
    run: async (message, args) => {
        ...
        if (voted) {
            ...
            if (!bonusCooldown.has(message.member.id)) {
                embed.setTitle("Vote <a:6093_Animated_Checkmark:716318362719879288> | " + message.member.user.username)
            ...
            embed.setTitle("Vote <a:1603_Animated_Cross:716318362644381757> | " + message.member.user.username)
            embed.setColor("#e4334f")
            embed.addField("Status", "N/A")
        }
